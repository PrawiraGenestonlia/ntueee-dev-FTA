...
import NTUEEE from '../assets/e3vis/E3VIS-logo-light.png';
    ...
    <div>
      <Form name="login-form" size="large" {...layout}>
        ...
        <Form.Item {...tailLayout}>
          ...
          <a className="float-right" onClick={() => { setShowModal(true) }} style={{ color: THEME_COLOR.FONT }}>
            Forgot password?
          </a>
        </Form.Item>
      </Form>
  ...
  return (
    <div className="flex flex-col w-screen h-screen" style={{ maxWidth: '2000px', backgroundImage: `url(${Background})`, backgroundSize: 'cover' }}>
      ...
      <div className="flex justify-center items-center" style={{ marginTop: '9rem' }}>
        <div className="flex justify-center p-3 rounded-lg" style={{ backgroundColor: THEME_COLOR.LOGIN_BOX, width: '80%' }}>
