    ...
    <>
      {
        ...
        <React.Fragment>
          <Menu left width={'100%'} customBurgerIcon={<img src={BurgerMenuSVG} alt="burger-menu" style={{ filter: THEME_COLOR.ICON_FILTER }} />}
            customCrossIcon={<img src={CloseSVG} alt="close-menu" style={{ filter: THEME_COLOR.ICON_FILTER }} />} isOpen={isNavOpen} onStateChange={isMenuOpen}>
          ...
          <div className="flex absolute h-full w-full justify-center items-center z-20" style={{ backgroundColor: THEME_COLOR.TOP_NAV_BURGER_BG }}>
            <div className="text-xl" style={{ color: THEME_COLOR.FONT }}>{headerText === 'Home' ?
              <>
                E3VIS
              </> :
              <>{headerText}</>
    ...
    <div className="flex flex-col w-full mt-0">
      ...
      }
      {
        ...
        <React.Fragment>
          ...
          <div id="main-screen-react" className=" w-full max-w-sm p-3 static">
